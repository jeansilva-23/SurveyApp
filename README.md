...
```
*(Se a compilação falhar com erros de "operator new" no C++, certifique-se de que não está usando o NDK 27 junto com uma versão incompatível do React Native, ou faça um `cd android && ./gradlew clean` para limpar o cache).*
